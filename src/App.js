...
class App extends Component {
  ...
  <div>
    ...
    />
      ...
      <div className="row">
      <label>Usuarios</label> <span>{this.state.Users.length}</span>
      <label>Casamentos marcados</label> <span>{this.state.Weddings.length}</span>
      <label>Budget(media)</label> <span>{this.state.BudgetAverage}</span>
      </div>
      <div className="row teste1">
      <ResponsiveBar
